...
1. User signs in.
2. User creates or select a project.
...
6. AI geneartes nodes and edges in the shared canvas.
...
- Project creatio, ownership and collaborator access.
...
- AI-powered Markdown specs generation from the canvas graph
- Persistent storage for project meradata and generated artifacts
- Spec download
