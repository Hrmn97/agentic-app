...
- let: compact logo, tagline, short text-only feature list
...
Create sign-in and sign-up pages using Cler components.
...
Keep Clerk's default user menu and profile flows intact. Do not rebuild heavily customize clerk internals.
